...
const CommandApp: React.FC = () => {
  ...
  const householdSections: HouseholdSection[] = [
    ...
    },
    {
      id: 'family',
      icon: Users,
      title: 'Family & Life Administration',
      score: 8.5,
      status: 'good',
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <svg viewBox="0 0 100 100" className="w-8 h-8">
              <circle cx="50" cy="50" r="8" fill="#C9A24D" />
              <circle cx="50" cy="50" r="35" fill="none" stroke="#C9A24D" strokeWidth="3" />
              {[0, 45, 90, 135, 180, 225, 270, 315].map((angle, i) => {
                ...
                return (
                  <g key={i}>
                    <line x1="50" y1="50" x2={x} y2={y} stroke="#C9A24D" strokeWidth="2.5" />
                    <circle cx={x} cy={y} r="5" fill="#C9A24D" />
                  </g>
                );
              })}
            </svg>
            <span className="font-bold text-xl">COMMAND</span>
          </div>
  ...
  const PriorityCard: React.FC<{ priority: Priority; onClick: () => void }> = ({ priority, onClick }) => (
    <div 
      onClick={onClick}
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between gap-4 mb-2">
            <h3 className="font-semibold text-gray-900 text-lg">{priority.title}</h3>
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 text-lg">Here's your household command center</p>
        </div>

        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl p-8 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-semibold mb-2 text-gray-300">Overall Household Health</h2>
              <div className="flex items-end gap-4">
                <span className="text-7xl font-bold">{overallScore}</span>
                <span className="text-3xl text-gray-400 pb-2">/100</span>
              </div>
            ...
            <div className="text-right">
              <div className="text-sm text-gray-400 mb-2">Sections Tracked</div>
              <div className="text-4xl font-bold">{householdSections.length}</div>
            </div>
          </div>
        </div>

        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Priority Actions</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Household Sections</h2>
